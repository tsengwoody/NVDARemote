...
addon_info = {
	...
	"addon_name" : "remote&broadcast",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on to be shown on installation and add-on information.
	"addon_summary" : _("Remote Broadcast Support"),
	# Add-on description
	...
	"addon_version" : "2.2",
	# Author(s)
	"addon_author" : u"Tyler Spivey <tspivey@pcdesk.net>, Christopher Toth <q@q-continuum.net>, Tseng Woody <tsengwoody.tw@gmail.com>",
